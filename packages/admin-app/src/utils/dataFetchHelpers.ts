import { Keychain, ReactSetter } from '@dh-test/common-utils';
import {
  FindMemberQuery,
  Haus,
  ITransformedProposalQuery,
} from '@dh-test/dao-data';
import { ErrorMessage } from '@dh-test/ui';
...
export const loadMember = async ({
  ...
  try {
    ...
    const haus = Haus.create({
      graphApiKeys: {
        '0x1': process.env['VITE_GRAPH_API_KEY_MAINNET'],
      },
    });
